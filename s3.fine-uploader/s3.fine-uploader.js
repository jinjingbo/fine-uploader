// Fine Uploader 5.99.0 - MIT licensed. http://fineuploader.com
(function(global) {
    ...
    qq.s3.util = qq.s3.util || function() {
        ...
        return {
            ...
            UNPREFIXED_PARAM_NAMES: [ "Cache-Control", "Content-Disposition", "Content-Encoding", "Content-MD5", "x-amz-security-token", "x-amz-server-side-encryption", "x-amz-server-side-encryption-aws-kms-key-id", "x-amz-server-side-encryption-customer-algorithm", "x-amz-server-side-encryption-customer-key", "x-amz-server-side-encryption-customer-key-MD5" ],
